...
```{r compute-picture-network-of-func, echo=TRUE}
require(codexplor)

codes_codexplor <-  get_doc_network_from_project(repos = "clement-LVD/codexplor")

str(ce_net, max.level = 1)  #

netd3 <- get_networkd3_from_igraph(codes_codexplor$citations_network
                                   , linkDistance = 40
                                   , charge = -100
                                   , legend = F 
                                   , title_h1 = "codexplor functions network")
...
"High-level" = c(
"Construct a network of internal dependancies : [vignette of `get_text_network_from_project`](https://clement-lvd.github.io/codexplor/articles/vignette_get_citations_network_from_project.html)"
