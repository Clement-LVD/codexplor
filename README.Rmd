...
**1. Turn a programming project into a corpus.** Given folder(s) and/or github repo(s) and programming language(s), `codexplor::get_doc_network_from_project` will return a `list` of dataframes :
...
This corpus is a standardized way to analyze a programming project as a collection of documents. Here a quick look on the returned df : 
...
, "![.](https://img.shields.io/badge/{🚧}-bold?style=flat&logoColor=black&logoSize=2&label=Line-level metrics&labelColor=grey&color=green)"
        ...
        , Global_insights = c( "Appreciate global complexity" 
