...
Once you have a network as the network of internal dependancies within a project computed by `get_text_network_from_project` (see the [vignette of `get_text_network_from_project`](https://clement-lvd.github.io/codexplor/articles/vignette_get_text_network_from_project.html))
...
- Turn it into an interactive `networkD3` dataviz with ![.](https://img.shields.io/badge/{networkD3}-bold?style=flat&logoColor=black&logoSize=2&label=get_networkd3_from_igraph()&labelColor=green&color=black)
          ...
          get_networkd3_from_igraph(filter_net)
