...
, "**Identify the unested - exposed - content** within the *codes lines*, in order to exclude the non-exposed functions (*aka* nested functions) from the matches of the next step"
 ...
 , Examples = c(paste('e.g., "R" language is associated with "`.R`" files and a default filtering pattern (i.e.', paste0(get_def_regex_by_language("R")$pattern_to_exclude, collapse = " ," )  )
...
It's a caveat of the text-mining approach, since there is no way to distinguishing a lambda function and a variable.

Another caveat unsupported - yey - is the 'hello' javascript function defined hereafter :
