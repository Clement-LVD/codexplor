...
This function will compute some text-mining metrics within each line (e.g., number of characters, words count) and within document-level.
...
By default `construct_corpus` try to analyze .R files. One or several `languages` could be passed to `construct_corpus`.
